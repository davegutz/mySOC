...
///	<param name="A1">A1 value (logic 0 or 1) of the RAM chip you want
///	to address. Default value 0.</param>
///</summary>
...
///		<returns>0:success, 1:data too long to fit in transmit
///		buffer, 2 : received NACK on transmit of address,
///		3 : received NACK on transmit of data, 4 : other error
///		</returns>
///</summary>
