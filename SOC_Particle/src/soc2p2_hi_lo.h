...
#define HDWE_UNIT \
  "soc2p2_hi_lo"  // https://console.particle.io/soc-particle-28171/
                  // devices/0a10aced202194944a04c040
#define SOFT_SBAUD \
...
#define ASK_DURING_BOOT \
  1  // Flag to ask for application of this file to * retained adjustments
