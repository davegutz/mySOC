...
// Ib hardware
#define IB_ABS_MAX_AMP        14.0 // Hard range limit of sensor electrically impossible (=1.65 *
...
#define HDWE_IB_HI_LO_NOA_LO -10. // Fully NOA bank disch transition, A (-10)
#define HDWE_IB_HI_LO_AMP_LO -9. // Fully AMP bank disch transition, A (-9)
