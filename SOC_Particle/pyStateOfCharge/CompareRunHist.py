...
def compare_run_hist(
    ...
    fig_list, fig_files = compare_run_sim(
        data_file=data_file,
        unit_key=unit_key,
        plots=plots,
        time_shift=time_shift,
        use_mon_soc_=use_mon_soc,
        verbose=verbose,
        scale_batt=scale,
        slr_hys_sim=slr_hys_sim,
        request_history=request_history_run_sim,
        init_time=init_time,
    ...
    _, _ = compare_hist_sim(
        ...
        plots=plots,
        Tb_force=Tb_force,
        request_history=request_history_hist_sim,
        terse=terse,
        strict_overplot=strict_overplot,
        fig_list=fig_list,
        fig_files=fig_files,
