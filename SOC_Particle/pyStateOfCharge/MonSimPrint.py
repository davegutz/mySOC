...
def print_dyn_m_RunSim(SN, i_temp, i_ekf, t, mon, sim, calc_temp, calc_ekf):
    ...
    hdr = (
        ...
        "    dt                vb                           ibmh                        i"
        "bmm                    ib_amp_lo     ib_amp_hi      ib_lo_active     dis_amp_flt"
        "   dt                    ib_amp                    ib_dyn_T_m          ib_dyn_rs"
        "tate_m                ib_dyn_lstate_m                      ib_dyn_m             "
        "   vb                     dv_dyn_m             vb_m                      voc_m  "
        "                   voc_soc               voc_soc_m                   e_wrap_m   "
        "               e_wrap_m_trim        e_wrap_trimmed_m         e_wrap_m_T         "
        "  e_wrap_m_rate            e_wrap_m_reset       e_wrap_m_state         e_wrap_m_"
        "filt        voc_soc                   voc_stat              vsat                "
        "      ib                      soc                       ewmhi_thr            ewm"
        "lo_thr           e_wrap_m_flt   e_wrap_m_fa    disable_amp_fault      ib_amp_lo "
        "    e_wrap_m_reset  fltw   falw"
    )
    ...
    print(
        ...
        "{:11.7f}".format(mon.vb),
        "{:14.5f}".format(SN.mon_run.ib_amp_hdwe[G.i]),
        "{:12.5f}".format(mon.ib_amp_hdwe),
        "{:14.5f}".format(SN.mon_run.ib_amp_model[G.i]),
        "{:12.5f}".format(mon.ib_amp_model),
        ...
        "{:18d}".format(bool(SN.mon_run.ib_lo_active[G.i])),
        ...
        "{:7.4f}".format(mon.dt),
        "{:15.6f}".format(SN.mon_run.ib_amp[G.i]),
        "{:13.6f}".format(mon.ib_amp),
        ...
        "{:21.5f}".format(SN.mon_run.ib_dyn_m[G.i]),
        "{:12.5f}".format(mon.LoopIbAmp.ib_dyn),
        "{:11.5f}".format(SN.mon_run.vb[G.i]),
        "{:9.5f}".format(mon.vb),
        "{:11.5f}".format(SN.mon_run.dv_dyn_m[G.i]),
        "{:8.5f}".format(mon.LoopIbAmp.dv_dyn),
        "{:13.6f}".format(SN.mon_run.vb_model[G.i]),
        "{:11.6f}".format(mon.LoopIbAmp.vb),
        "{:13.6f}".format(SN.mon_run.voc_m[G.i]),
        "{:11.6f}".format(mon.LoopIbAmp.voc),
        "{:13.6f}".format(SN.mon_run.voc_soc[G.i]),
        "{:9.6f}".format(mon.voc_soc),
        "{:11.6f}".format(SN.mon_run.voc_soc_m[G.i]),
        "{:11.6f}".format(mon.LoopIbAmp.voc_soc),
        "{:13.5f}".format(SN.mon_run.e_wrap_m[G.i]),
        "{:8.5f}".format(mon.e_wrap_m),
        "{:16.5f}".format(SN.mon_run.e_wrap_m_trim[G.i]),
        "{:8.5f}".format(mon.e_wrap_m_trim),
        "{:12.6f}".format(SN.mon_run.e_wrap_m_trimmed[G.i]),
        "{:9.6f}".format(mon.LoopIbAmp.e_wrap_trimmed),
        ...
        "{:11.5f}".format(SN.mon_run.ewmhi_thr[G.i]),
        "{:8.5f}".format(mon.ewmhi_thr),
        "{:11.5f}".format(SN.mon_run.ewmlo_thr[G.i]),
        "{:8.5f}".format(mon.ewmlo_thr),
        "{:8d}".format(SN.mon_run.wrap_hi_m_flt[G.i]),
        "{:4d}".format(mon.wrap_hi_m_flt),
        "{:8d}".format(SN.mon_run.wrap_hi_m_fa[G.i]),
        ...
        "{:18d}".format(SN.mon_run.fltw[G.i]),
...
def print_dyn_n_RunSim(SN, i_temp, i_ekf, t, mon, sim, calc_temp, calc_ekf):
    ...
    hdr = (
        ...
        "   reset_all_faults   soft_reset  soft_reset_sim  init_mon     init_sim     sa  "
        "    dt                 vb                            ibmh                       "
        "  ibmm                    ib_noa_lo    ib_noa_hi      dt                    ib_n"
        "oa                    ib_dyn_T_n          ib_dyn_rstate_n                ib_dyn_"
        "lstate_n                      ib_dyn_n                 vb                      d"
        "v_dyn_n                vb_n                       voc_n                      voc"
        "_soc                   voc_soc_n                    e_wrap_n                  e_"
        "wrap_n_trim        e_wrap_trimmed_n         e_wrap_n_T           e_wrap_n_rate  "
        "          e_wrap_n_reset       e_wrap_n_state          e_wrap_n_filt          ew"
        "mhi_thr              ewmlo_thr          e_wrap_n_flt   e_wrap_n_fa    ib_noa_lo "
        "  fltw   falw  e_wrap_n_filt"
    )
    if (calc_temp or calc_ekf) and count_since_last_header > HDR_SPREAD:
        print(hdr)
        count_since_last_header = 0
    ...
    print(
        ...
        "{:9.4f}".format(SN.mon_run.dt[G.i]),
        "{:7.4f}".format(mon.dt),
        "{:14.7f}".format(SN.mon_run.vb[G.i]),
        "{:12.7f}".format(mon.vb),
        "{:15.5f}".format(SN.mon_run.ib_noa_hdwe[G.i]),
        "{:13.5f}".format(mon.ib_noa_hdwe),
        "{:15.5f}".format(SN.mon_run.ib_noa_model[G.i]),
        "{:13.5f}".format(mon.ib_noa_model),
        ...
        "{:11.4f}".format(SN.mon_run.dt[G.i]),
        "{:7.4f}".format(mon.dt),
        "{:15.6f}".format(SN.mon_run.ib_noa[G.i]),
        "{:13.6f}".format(mon.ib_noa),
        ...
        "{:21.5f}".format(SN.mon_run.ib_dyn_n[G.i]),
        "{:12.5f}".format(mon.LoopIbNoa.ib_dyn),
        "{:12.5f}".format(SN.mon_run.vb[G.i]),
        "{:10.5f}".format(mon.vb),
        "{:12.5f}".format(SN.mon_run.dv_dyn_n[G.i]),
        "{:10.5f}".format(mon.LoopIbNoa.dv_dyn),
        "{:13.6f}".format(SN.mon_run.vb_model[G.i]),
        "{:12.6f}".format(mon.LoopIbNoa.vb),
        "{:13.6f}".format(SN.mon_run.voc_n[G.i]),
        "{:12.6f}".format(mon.LoopIbNoa.voc),
        "{:13.6f}".format(SN.mon_run.voc_soc[G.i]),
        "{:12.6f}".format(mon.voc_soc),
        "{:12.6f}".format(SN.mon_run.voc_soc_n[G.i]),
        "{:12.6f}".format(mon.LoopIbNoa.voc_soc),
        "{:13.5f}".format(SN.mon_run.e_wrap_n[G.i]),
        ...
        "{:12d}".format(bool(SN.mon_run.ib_wrp_reset_n[G.i])),
        "{:9d}".format(bool(mon.LoopIbNoa.WrapErrFilt.reset)),
        "{:12.6f}".format(SN.mon_run.ib_wrp_state_n[G.i]),
        "{:9.6f}".format(mon.LoopIbNoa.WrapErrFilt.state),
        "{:12.5f}".format(SN.mon_run.e_wrap_n_filt[G.i]),
        "{:9.5f}".format(mon.e_wrap_n_filt),
        "{:12.5f}".format(SN.mon_run.ewmhi_thr[G.i]),
        "{:9.5f}".format(mon.ewmhi_thr),
        "{:12.5f}".format(SN.mon_run.ewmlo_thr[G.i]),
        "{:9.5f}".format(mon.ewmlo_thr),
        "{:8d}".format(SN.mon_run.wrap_hi_n_flt[G.i]),
        "{:4d}".format(mon.wrap_hi_n_flt),
        "{:8d}".format(SN.mon_run.wrap_hi_n_fa[G.i]),
...
def print_vb_wrap_RunSim(SN, i_temp, i_ekf, t, mon, sim, calc_temp, calc_ekf):
    ...
    hdr = (
        "  i   time     r       rt   rk   it   ct      re   ie  ce    reset  reset_temp  "
        "   reset_all_faults   soft_reset  soft_reset_sim  init_mon     init_sim     sa  "
        "    bms_off     voltage_low   bms_off_s   voltage_low_s  dt                vb   "
        "                        ib_amp                      vb_m                      vo"
    ...
    print(
        ...
        "{:4d}".format(bool(mon.bms_off)),
        "{:7d}".format(bool(SN.mon_run.voltage_low[G.i])),
        "{:4d}".format(bool(mon.voltage_low)),
        "{:7d}".format(bool(SN.sim_run.bms_off_s[G.i])),
