...
def print_volt_RunSim(SN, i_temp, i_ekf, t, mon, sim, calc_temp, calc_ekf, df=False):
    ...
    for i_hdr in range(int(print_hdr), -1, -1):
        ...
        print_pair(SN.mon_run.ib_diff_T[G.i], mon.Diff.ib_diff_T, 14, 6, 'ib_diff_T', h, df)
        print_pair(SN.mon_run.ib_diff_rstate[G.i], mon.Diff.ib_diff_rstate, 14, 6, 'ib_diff_rstate', h, df)
        print_pair(SN.mon_run.ib_diff_state[G.i], mon.Diff.ib_diff_state, 14, 6, 'ib_diff_state', h, df)
        print_pair(SN.mon_run.ib_diff_tau[G.i], mon.Diff.ib_diff_tau, 14, 6, 'ib_diff_tau', h, df)
