...
for i in range(len(data_raw.time)):
    if i == 0:
        ...
        sampf.append(1.0 / (data_raw.time[i] - data_raw.time[i - 1]))
...
plt.plot(
    data_raw.time, data_raw.Vcn, color="green", linestyle="-", label="Vc noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Time, s")
plt.ylabel("Volts")
...
plt.figure(figsize=(10, 6))
plt.plot(
    data_raw.time, data_raw.VoVcn, color="red", linestyle="--", label="Vo-Vc Noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Time, s")
plt.ylabel("Volts")
...
plt.figure(figsize=(10, 6))
plt.plot(
    data_raw.time, sampf, color="green", linestyle="-", label="Sample Vc frequency, Hz"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Time, s")
plt.ylabel("Hz")
...
plt.figure(figsize=(10, 6))
plt.semilogx(
    freqs_rps / (2 * np.pi), power_Vcn, color="blue", linestyle="--", label="Vc noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
...
plt.figure(figsize=(10, 6))
plt.semilogx(
    freqs_rps / (2 * np.pi), power_Von, color="magenta", linestyle="-", label="Vo noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Frequency (Hz)")
plt.ylabel("Power")
...
plt.figure(figsize=(10, 6))
plt.semilogx(
    freqs_rps / (2 * np.pi), power_Vo_Vcn, color="magenta", linestyle="-", label="Vo-Vc noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Frequency (Hz)")
plt.ylabel("Power")
