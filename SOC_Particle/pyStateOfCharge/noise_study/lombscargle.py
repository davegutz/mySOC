...
# Obtain data by:  Cx2500 (Cx10000 for build of Vca only).  Save as 'burst'  Data is approximately 40 Hz so Nyquist is
# 20 Hz = 125 r/s
...
# data_file_clean = 'G:/My
# Drive/GitHubArchive/SOC_Particle/dataReduction\\g20250612a\\burstCapNoa104_soc2p2_hi_lo_chg.csv'
# data_file_clean = 'G:/My Drive/GitHubArchive/SOC_Particle/dataReduction\\g20250612a\\burstRebase_soc2p2_hi_lo_chg.csv'
data_file_clean = (
    "G:/My Drive/GitHubArchive/SOC_Particle/dataReduction\\g20250612a\\burst_forced0V+V-_soc2p2_hi_lo_chg.csv"
)
...
plt.plot(
    data_raw.time, data_raw.Voa, color="magenta", linestyle="-", label="Vo amp at ADC, Volts"
)  # Convert to Hz for x-axis
plt.plot(
    data_raw.time, data_raw.Von, color="red", linestyle="--", label="Vo noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.plot(
    data_raw.time, data_raw.Vcn - 0.05, color="blue", linestyle="--", label="Vc noa -0.05 at ADC, Volts"
)  # Convert to Hz for x-axis
plt.plot(
    data_raw.time, data_raw.Vca - 0.05, color="green", linestyle="-", label="Vc amp -0.05 at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Time, s")
plt.ylabel("Volts")
...
plt.figure(figsize=(10, 6))
plt.plot(
    data_raw.time, data_raw.Vbv, color="orange", linestyle="--", label="Vb at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
...
plt.figure(figsize=(10, 6))
plt.plot(
    data_raw.time, data_raw.Tbv, color="black", linestyle="-", label="Tb at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Time, s")
plt.ylabel("Volts")
...
plt.figure(figsize=(10, 6))
plt.plot(
    data_raw.time, data_raw.VoVca, color="magenta", linestyle="-", label="Vo-Vc amp at ADC, Volts"
)  # Convert to Hz for x-axis
plt.plot(
    data_raw.time, data_raw.VoVcn, color="blue", linestyle="--", label="Vo-Vc noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Time, s")
plt.ylabel("Delta V")
...
plt.figure(figsize=(10, 6))
plt.semilogx(
    freqs_rps / (2 * np.pi), power_Voa, color="magenta", linestyle="-", label="Vo amp at ADC, Volts"
)  # Convert to Hz for x-axis
plt.semilogx(
    freqs_rps / (2 * np.pi), power_Von, color="blue", linestyle="--", label="Vo noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Frequency (Hz)")
plt.ylabel("Power")
...
plt.figure(figsize=(10, 6))
plt.semilogx(
    freqs_rps / (2 * np.pi), power_VoVca, color="magenta", linestyle="-", label="Vo-Vc amp at ADC, Volts"
)  # Convert to Hz for x-axis
plt.semilogx(
    freqs_rps / (2 * np.pi), power_VoVcn, color="blue", linestyle="--", label="Vo-Vc noa at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Frequency (Hz)")
plt.ylabel("Power")
...
plt.figure(figsize=(10, 6))
plt.semilogx(
    freqs_rps / (2 * np.pi), power_Tbv, color="red", linestyle="-", label="Tbv at ADC, Volts"
)  # Convert to Hz for x-axis
plt.semilogx(
    freqs_rps / (2 * np.pi), power_Vbv, color="blue", linestyle="--", label="Vbv at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
plt.xlabel("Frequency (Hz)")
plt.ylabel("Power")
