...
# Drive/GitHubArchive/SOC_Particle/dataReduction\\g20250612a\\burstVcCx10000_soc2p2_hi_lo_chg.csv'
...
nyquist = 92.5 / 2.0  # get this by looking at plots and rerunning
numpts = len(data_raw)
...
plt.plot(
    data_raw.time, data_raw.Vca, color="green", linestyle="-", label="Vc amp at ADC, Volts"
...
plt.figure(figsize=(10, 6))
plt.semilogx(
    freqs_rps / (2 * np.pi), power_Vca, color="blue", linestyle="--", label="Vc amp at ADC, Volts"
)  # Convert to Hz for x-axis
plt.legend(loc=1)
