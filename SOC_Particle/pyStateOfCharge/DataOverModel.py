            ...
            for line in input_file:
                ...
                if line.__contains__(unit_key) and not line.__contains__("Config:"):
                    ...
                    if (
                        ...
                        and line.count(";") == 0
                        and num_text == num_text_run
                        and re.search(r"[^a-zA-Z0-9+-_.:, ]", line[:-1]) is None
                        and (num_lines == 0 or ((num_lines + 1) % skip) == 0)
                        ...
                        print(
                            f"  line.count(',') == num_fields  {line.count(',') == num_fields}   \
