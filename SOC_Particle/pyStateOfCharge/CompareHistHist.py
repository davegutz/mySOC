...
def compare_hist_hist(
    ...
    mon_run, sim_run, unit_run, fault_run, hist_20C_run, filename_run, Battery_run = load_hist_and_prep(
        data_file=data_file_run, unit_key=unit_key_run, dt_resample=dt_resample
    )
    mon_run.str = "h1"
    mon_tst, sim_tst, unit_tst, fault_tst, hist_20C_tst, filename_tst, Battery_tst = load_hist_and_prep(
        data_file=data_file_tst, unit_key=unit_key_tst, dt_resample=dt_resample
    )
    mon_tst.str = "h2"
