...
def gp_2(S: PlotOptions, fig_files=None, fig_list=None):
    ...
    plq(
        plt, S.mr, "time", S.mr, "voc_stat_f", color="cyan", linestyle="-.", warn=not S.run_is_stdy and not S.run_is_run
    )
    plq(
        plt, S.mv, "time", S.mv, "voc_stat_f", color="black", linestyle=":", warn=not S.ver_is_stdy and not S.run_is_run
    )
    plt.legend(loc=1)
    plt.subplot(222)
    ...
    plq(
        ...
        color="magenta",
        linestyle="-.",
        warn=not S.ver_is_stdy and not S.ver_is_run,
    )
...
def gp_2_nn_lag(S: PlotOptions, fig_files=None, fig_list=None):
    ...
    plq(
        ...
        color="orange",
        linestyle="--",
        warn=not S.ver_is_stdy and not S.ver_is_sim and not S.ver_is_run,
    )
    ...
    plt.legend(loc=1)
    plt.subplot(324)
    plq(plt, S.mr, "time", S.mr, "ib", add=10.0, color="black", linestyle="-", warn=not S.run_is_stdy)
    plq(plt, S.mr, "time", S.mr, "ib_f", add=10.0, color="black", linestyle="-", warn=S.run_type == "HistHist")
    plq(plt, S.mv, "time", S.mv, "ib", add=10.0, color="orange", linestyle="--", warn=not S.ver_is_stdy)
    plq(plt, S.mv, "time", S.mv, "ib_f", add=10.0, color="orange", linestyle="--", warn=S.run_type == "HistHist")
...
def gp_3_ekf(S: PlotOptions, fig_files=None, fig_list=None):
    ...
    plq(
        ...
        color="orange",
        linestyle="--",
        warn=not S.run_is_run and not S.ver_is_stdy,
    )
    ...
    plt.text(
        0.5,
        0.2,
        "KF_Q_STD= " + "{:10.6f}".format(Battery.KF_Q_STD) + "KF_R_STD= " + "{:10.6f}".format(Battery.KF_R_STD),
...
def gp_3_tune(S: PlotOptions, fig_files=None, fig_list=None):
    ...
    plq(
        ...
        color="green",
        linestyle="-",
        warn=not S.ver_is_stdy and not S.ver_is_run and not S.run_is_run,
    )
    plq(
        plt,
        S.smv,
    ...
    plq(plt, S.mr, "time", S.mr, "voc_stat_f", add=-1.0, color="orange", linestyle="-", warn=not S.run_is_run)
    plq(
        plt,
        S.mv,
        "time",
        ...
        color="blue",
        linestyle="--",
        warn=not S.ver_is_sim and not S.ver_is_run,
    )
    plq(plt, S.mr, "time", S.mr, "voc_stat", add=-1.0, color="orange", linestyle="-", warn=not S.run_is_stdy)
    plq(plt, S.mv, "time", S.mv, "voc_stat", add=-1.0, color="blue", linestyle="--", warn=not S.ver_is_stdy)
    plq(plt, S.sr, "time", S.sr, "voc_stat_s", add=-1.0, color="blue", linestyle="-.", warn=not S.run_is_stdy)
    plq(
        plt,
        S.smr,
        "time",
    ...
    if S.run_type == "HistSim":
        plq(plt, S.mr, "time", S.mr, "vb_f", add=-2.0, color="black", linestyle="-")
        plq(plt, S.mv, "time", S.mv, "vb", add=-2.0, color="red", linestyle="--")
    plq(plt, S.mr, "time", S.mr, "vb", add=-2.0, color="black", linestyle="-", warn=not S.run_is_stdy)
    plq(plt, S.mv, "time", S.mv, "vb", add=-2.0, color="green", linestyle="--", warn=not S.ver_is_stdy)
    plq(plt, S.sr, "time", S.sr, "vb_s", add=-2.0, color="red", linestyle="-.", warn=not S.run_is_stdy)
    plq(
        plt,
        S.smv,
        "time",
        ...
        color="pink",
        linestyle="--",
        warn=not S.ver_is_stdy and not S.run_is_stdy,
    )
    plt.xlabel("sec")
    saved_fontsize = plt.rcParams["legend.fontsize"]
    plt.rcParams["legend.fontsize"] = "6"
    ...
    plq(
        plt, S.smv, "time", S.smv, "vb_s_v", color="magenta", linestyle=":", warn=not S.ver_is_stdy and not S.ver_is_run
    )
    plt.xlabel("sec")
    plt.legend(loc=2)
    plt.subplot(338)
