...
def enter_string():
    answer = tk.simpledialog.askstring(
        title=__file__, prompt="enter tail-f destination file", initialvalue=string.get()
    )
    string.set(answer)
...
def enter_tail_file_name():
    answer = tk.simpledialog.askstring(
        title=__file__, prompt="enter tail-f destination file", initialvalue=tail_file.get()
    )
