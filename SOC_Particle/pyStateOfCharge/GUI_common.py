...
if plat == "linux":
    ...
    default_dr = (
        "/Users/daveg/Library/CloudStorage/GoogleDrive-davegutz2006@gmail.com/My "
        "Drive/GitHubArchive/SOC_Particle/dataReduction"
    )
else:
...
tranPrepOff = "HR;Dh1000;W2;Rs;W148;vv4;W40;"
...
vm12 = "Dv-12;"
off_r = (
    "Xa-0.1;Bb;Sk-0.1;vv68;qs300000;qm300000;Dw-0.1;Xf-0.1;DI-0.1;DA-0.1;"
...
lookup = {
    ...
    "noaHiFail": (
        ...
        (
            ...
            "Loss of ib set 'accy' because loss of current sensing at high currents.",
        ),
    ),
    "rapidTweakRegression": (
        230,
    ...
    "pulseSoft": (
        ...
        (
            ...
            "uld be nearly flat after a pulse response.",
            "This is the shortest of all tests.  Also useful for quick check tests.",
            "",
        ),
    ),
    "pulseHard": (
    ...
    "rapidTweakRegressionH0": (
        ...
        (
            ...
            "Tease out cause of e_wrap faults.  e_wrap MUST be flat!",
            "Occasional jumps in ib_sel_stat are normal when pass through 0 A",
        ),
    ),
    "offLowSoc": (
    ...
    "triTweakDisch": (
        ...
        (
            "Should run three very large current discharge/recharge cycles without fault",
            "Best test for seeing time skews and checking fault logic for false trips",
            "Occasional jumps in ib_sel_stat are normal when pass through 0 A.  Also hyst evident in one _s model",
        ),
    ),
    "ampHiFailFf": (
        150,
        ...
        (
            ...
            "Run about 60s. Start by looking at 'Ult 1'. No fault record "
            "(keeps recording).  Verify that on Fig 3 the e_wrap goes thr"
            "ough a threshold ~0.4 without change of 'ib_sel_stat'",
            "This show when deploy with Fake Faults (Ff) don't throw false trips (it happened)",
            "ib_amp limited by max range e.g. 12.6.  ib_diff_fa will set "
            "red_loss but wait for wrap_fa to isolate and make selection "
            "change",
        ),
    ),
    "ampLoFail": (
    ...
    "satSitCHG": (
        690,
        "Xm247;Ca0.986;" + fastTwitchDef + "Xa17;" + tranPrep + "XR;XQ600000;" + "Xa0;" + quiet + cleanup + "<XD;",
        (
            "Should run one saturation and de-saturation event without fault.   Takes about 15 minutes.",
            "operate around saturation, starting below, go above, come back down. Tune Ca to start just below vsat",
        ),
    ...
    "flatSit": (
        690,
        "Xm247;Ca0.9;Rb;Rf;Xts;Xa-81;Xf0.004;XW10000;XT10;XC2;W1;"
        + (tranPrep + "XR;XQ580000;Xa0;Xb0;" + quiet + cleanup + "<XD;"),
        (
    ...
    "offSitBmsNoiseBB": (
        ...
        (
            ...
            "operate around saturation, starting above, go below, come ba"
    ...
    "noaHiFailSlow": (
        ...
        (
            ...
            "Will display “diff” due to 20A difference.",
            "EKF won't move because fed by amp.",
            "Run for 6  minutes to verify not cc_diff_fa",
        ),
    ),
    "noaHiFailSlower": (
        525,
    ...
    "vHiFail": (
        190,
        modHalfInit + tranPrep + "XY;Dv0.82;XQ60000;" + dv0 + quiet + cleanup + "<XD;",
        (
    ...
    "vHiFailFf": (
        ...
        (
            ...
            "Should detect voltage failure (see DOM1) but not display anything on display.",
            "Usually shows SAT.",
        ),
    ),
    "pulseSSH": (
        -15,
        synced_slow + "Xp8;" + quiet + cleanup + "<XD;",
        (
            "Should generate a very short <10 sec data burst with a hw pu"
            "lse.  Look at plots for good overlay. e_wrap should be flat.",
            "This is the shortest of all tests.  Useful for quick checks.",
            "ib_diff_flt will take time beyond event to reset running Hi-Lo.",
        ),
    ),
    "tLoFailModel": (
        275,
    ...
    "ibDualMid": (
        ...
        (
            ...
            "'*fail' will be displayed. After a bit more, current display will change to 0.",
            "To evaluate plots, start looking at 'Ult 1'. Fault record (frozen).",
        ),
    ),
    "ibDualFlat": (
